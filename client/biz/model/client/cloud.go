...
type Student struct {
	...
	College *College `thrift:"college,3,required" form:"college,required" json:"college,required" query:"college,required"`
...
type StudentService interface {
	Register(ctx context.Context, info *Student) (r *RegisterResp, err error)
...
func (p *StudentServiceClient) Register(ctx context.Context, info *Student) (r *RegisterResp, err error) {
...
func (p *studentServiceProcessorRegister) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	...
	if retval, err2 = p.handler.Register(ctx, args.Info); err2 != nil {
...
var StudentServiceRegisterArgs_Info_DEFAULT *Student

func (p *StudentServiceRegisterArgs) GetInfo() (v *Student) {
	if !p.IsSetInfo() {
		return StudentServiceRegisterArgs_Info_DEFAULT
	}
	return p.Info
}
...
func (p *StudentServiceRegisterArgs) IsSetInfo() bool {
	return p.Info != nil
}
